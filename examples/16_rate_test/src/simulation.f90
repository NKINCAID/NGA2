...
contains
   ...
   subroutine simulation_run
      ...
      CHARACTER(LEN=*), PARAMETER :: FMT1 = "(A8, A20, A20)"
      CHARACTER(LEN=*), PARAMETER  :: FMT2 = "(I8, 5ES20.7, 5ES20.7)"

      P = fc%Pthermo
      T = fc%SC(1,1,1,nspec+1)
      y = fc%SC(1,1,1, 1:nspec)
      wdot = 0.0_WP

      !ecular weight inverse
      inv_W_g = 0.0_WP
      do n =1, nspec
      ...
      print *, "---------------------------------------------------------------"
      WRITE(*,FMT1) "Index", "Rate Constant", "Reaction Rate"
      print *, "---------------------------------------------------------------"

      do i = 1, nreac + nreac_reverse
         WRITE(*,FMT2) i, k(i), w(i)
         print *, "---------------------------------------------------------------"
      end do 
      ...
      print *, "---------------------------------------------------------------"
      WRITE(*,FMT1) "Spec", "Mass fraction", "Concentration"
      print *, "---------------------------------------------------------------"

      do i = 1, nspec
         WRITE(*,FMT2) i, y(i), c(i)
         print *, "---------------------------------------------------------------"
