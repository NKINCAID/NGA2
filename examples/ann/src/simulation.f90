...
contains
   ...
   subroutine simulation_init
      ...
      if (Zst.eq.0.0_WP) Zst=Zst+epsilon(Zst)
      if (Zst.eq.1.0_WP) Zst=Zst-epsilon(Zst)
      ...
      allocate_work_arrays: block
         ...
         allocate(drho (sc%cfg%imino_:sc%cfg%imaxo_,sc%cfg%jmino_:sc%cfg%jmaxo_,sc%cfg%kmino_:sc%cfg%kmaxo_))
